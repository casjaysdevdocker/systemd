...
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
##@Version           :  202207241810-git
# @@Author           :  jason
# @@Contact          :  jason@vm-jason
# @@License          :  WTFPL
# @@ReadME           :  entrypoint-systemd.sh --help
# @@Copyright        :  Copyright: (c) 2022 jason, jason
# @@Created          :  Sunday, Jul 24, 2022 18:10 EDT
# @@File             :  entrypoint-systemd.sh
# @@Description      :
